...
<div class="box" style="height:100%">
  ...
  <div class="box-body" style="height:100%">
    ...
    <div class="tab-content content" style="height:100%">
      ...
      <div id="lama" class="tab-pane fade <?php count(array_merge($hari_ini, $yad)) == 0 and print('show active')?>" role="tabpanel" style="height:100%">
        <marquee onmouseover="this.stop()" onmouseout="this.start()" scrollamount="2" direction="up" width="100%" height="73%" align="center">
