...
<div class="max-w-full w-full lg:pb-5 overflow-auto">
  <figure class="h-32 lg:h-40 w-1/2 lg:w-1/3 float-left pr-3 relative <?php $image === gambar_desa($desa['logo']) ?>">
    <img src="<?= $image ?>" style="position: relative; height: 100%; top: 0; left:0;" 
      ...
      <div class="text-xs lg:text-sm text-white p-2" style="z-index:1000; background-color:#8a0090; position: absolute; opacity: 0.85; bottom:0; left:0;">
